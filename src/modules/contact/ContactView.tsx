...
export const ContactView = () => {
	return (
		<Container
			size="full"
			className="relative bg-[#05060A]  py-0 z-0 overflow-hidden "
		>
			<Image
				src={fondo}
				alt="fondo"
			...
			/>
			<h2 className="text-5xl font-black text-center text-white relative z-10 mt-16">
				Contacto
			</h2>
			<Container id="contacto" className="w-full relative z-10 max-w-[1100px]">
				<div className=" grid w-full  grid-cols-1 gap-16 pb-20  text-white  lg:grid-cols-2">
					...
					<div className="border border-gray-400 bg-gradient-to-t from-[#232323] to-[#030107] px-6 py-12 md:rounded-lg lg:px-10">
						<div className="mb-2">
